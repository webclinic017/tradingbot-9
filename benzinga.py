...
class Benzinga:
    ...
    def get_losers(self):
        response = requests.get(
                "https://data-api-pro.benzinga.com/rest/movers?apikey=aH0FkLCohY5yxK6OEaJ28Zpv51Ze1GyY&maxResults=100&session=REGULAR&screenerQuery=marketCap_gt_300000000%3BpreviousClose_gt_5&gainers=true")
        result = response.json()
