...
def main():
    ...
    stock_alert_filename= "predictions/finviz/"+"stock_alert_bull_type_1_"+str(date.today())+".csv"
    stoploss_alert_filename= "predictions/finviz/"+"stoploss_alert_bull_type_1_"+str(date.today())+".csv"
    target_achieved_filename =  "predictions/finviz/"+"target_achieved_bull_type_1_"+str(date.today())+".csv"
