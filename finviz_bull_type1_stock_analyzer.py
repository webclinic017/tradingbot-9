...
def main():
    ...
    stock_alert_filename= "stock_alert_bull_type_1_"+str(date.today())+".csv"
    stoploss_alert_filename= "stoploss_alert_bull_type_1_"+str(date.today())+".csv"
    target_achieved_filename =  "target_achieved_bull_type_1_"+str(date.today())+".csv"
