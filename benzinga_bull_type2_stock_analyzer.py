...
def main(assHand=None):
    ...
    stoploss_alert_filename = "predictions/benzinga/"+"stoploss_alert_bull_type_2_" + str(date.today()) + ".csv"
    target_achieved_filename = "predictions/benzinga/"+"target_achieved_bull_type_2_" + str(date.today()) + ".csv"
